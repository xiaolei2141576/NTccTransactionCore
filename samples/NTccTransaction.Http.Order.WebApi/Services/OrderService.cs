...
namespace NTccTransaction.Http.Order.WebApi
{
    public class OrderService : IOrderService, INTccTransactionService
    {
        ...
        public OrderService(ILogger<OrderService> logger, ICapitalProxy capitalProxy, IUserProxy userProxy, IOrderService1 orderService1)
        {
            _logger = logger;
        ...
        public async Task<string> PostOrder(string input, TransactionContext transactionContext = null)
        {
            ...
            await _capitalProxy.Record(null);
            await _userProxy.Record(null);
